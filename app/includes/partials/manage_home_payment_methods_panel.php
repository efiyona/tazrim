...
<div id="payment-method-delete-modal" class="modal">
    <div class="modal-content" style="max-width:460px;">
        <div class="modal-header"><h3>מחיקת אמצעי תשלום</h3><button type="button" class="close-modal-btn" onclick="closePaymentMethodDelete()" aria-label="סגור"><i class="fa-solid fa-xmark"></i></button></div>
        <div class="modal-body">
            <div style="text-align:center;margin-bottom:20px;"><div style="width:58px;height:58px;border-radius:50%;background:#fee2e2;color:var(--error);display:inline-flex;align-items:center;justify-content:center;font-size:1.35rem;"><i class="fa-solid fa-triangle-exclamation"></i></div><h3 style="margin:12px 0 6px;">מה לעשות עם הפעולות המשויכות?</h3><p style="color:var(--text-light);margin:0;">המחיקה סופית ולא ניתן לבטל אותה.</p></div>
            <div style="display:grid;gap:10px;"><button type="button" class="btn-primary btn-primary--outline" onclick="confirmPaymentMethodDelete('move_to_default')"><i class="fa-solid fa-arrow-right-arrow-left"></i> העבר לברירת מחדל</button><button type="button" class="btn-primary" style="background:var(--error);" onclick="confirmPaymentMethodDelete('delete_transactions')"><i class="fa-solid fa-trash-can"></i> מחק גם את הפעולות</button><button type="button" class="btn-primary btn-primary--outline" onclick="closePaymentMethodDelete()">ביטול</button></div>
        </div>
    </div>
</div>
