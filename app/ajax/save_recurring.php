...
$payment_method_supplied = array_key_exists('payment_method_id', $_POST);
$payment_method_id = $payment_method_supplied ? tazrim_resolve_payment_method_id($home_id, $_POST['payment_method_id']) : null;
