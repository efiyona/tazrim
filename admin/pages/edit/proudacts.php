<?php
  ...
  $proudacts = selectOne('proudacts', ['id' => $_GET['update_id']]);
  if(!isset($proudacts)){
                ...
                <form method="POST" enctype="multipart/form-data" class="form--container flex--start--c gap20 form--check">   
                  <div class="flex--start full--row gap30">
                    <label class="form--label flex--start--c gap5">
                      תיאור:
                      <input class="required" type="text" name="description" autocomplete="off" value="<?php if(isset($proudacts['description'])){echo $proudacts['description'];} ?>">
                    </label>
                    <label class="form--label flex--start--c gap5">
                      מחיר:
                      <input type="text" name="price" autocomplete="off" value="<?php if(isset($proudacts['price'])){echo $proudacts['price'];} ?>">
                    </label>
                  </div>
                  <label class="form--label flex--start--c gap5">
                      קישור לתשלום:
                      <input type="text" name="payment_link" autocomplete="off" value="<?php if(isset($proudacts['payment_link'])){echo $proudacts['payment_link'];} ?>">
                  </label>
                  <br>
                  <label class="form--label flex--start--c gap5">
                    <input type="submit" class="btn btn--large flex--center gap10" name="update_proudact" value="עדכון פרטי הכפתור" autocomplete="off">
                  </label>
                </form>
              </div>
            </div>
