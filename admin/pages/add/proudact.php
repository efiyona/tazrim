                ...
                <form method="POST" enctype="multipart/form-data" class="form--container flex--start--c gap20 form--check">   
                    <div class="flex--start full--row gap30">
                        <label class="form--label flex--start--c gap5">
                            תיאור:
                            <input class="required" type="text" name="description" autocomplete="off">
                        </label>
                        <label class="form--label flex--start--c gap5">
                            מחיר:
                    ...
                    <label class="form--label flex--start--c gap5">
                        קישור לתשלום:
                        <input class="required" type="text" name="payment_link" autocomplete="off">
                    </label>
                    <br>
                  <label class="form--label flex--start--c gap5">
                    <input type="submit" class="btn btn--large flex--center gap10" name="add_proudact" value="שמירת כפתור" autocomplete="off">
                  </label>
                </form>
              </div>
            </div>
