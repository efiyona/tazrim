(function () {
    function initFkLookups(scope) {
        ...
        scopeEl.querySelectorAll('.admin-fk-lookup').forEach(function (wrap) {
            if (wrap.getAttribute('data-fk-initialized') === '1') return;
            wrap.setAttribute('data-fk-initialized', '1');
            ...
            function runFetch() {
                ...
                fetch(url, { credentials: 'same-origin' })
                    ...
                    .then(function (data) {
                        ...
                        var selectedId = hidden.value ? String(hidden.value) : '';
                        list.innerHTML = '';
    ...
    window.tazrimAdminInitFkLookups = initFkLookups;
    initFkLookups(document);
})();
