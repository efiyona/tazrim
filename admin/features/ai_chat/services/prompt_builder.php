...
if (!function_exists('admin_ai_chat_build_agent_instructions')) {
    function admin_ai_chat_build_agent_instructions(): string
    {
        ...
        return "### מצב סוכן (Agent Mode) — שליפת נתונים וביצוע פעולות\n\n"
            ...
            . "- המנהל ביקש שינוי סכמה (להוסיף/לשנות/למחוק עמודה, ליצור/לשנות/למחוק טבלה, להוסיף אינדקס וכד׳).\n"
            . "- הפעולה לא אפשרית דרך CRUD הרגיל (למשל UPDATE עם WHERE מורכב, או פעולה על טבלה שמחוץ ל-whitelist).\n\n"
            . "**מתי לא להשתמש:**\n"
            . "- עדכון/יצירה/מחיקה פשוטים על טבלה מה-whitelist — העדף `create`/`update`/`delete` רגילים (הם בטוחים יותר ועם typed fields).\n"
            ...
            . "6. **עדכון סיסמה** — לא נתמך ישירות דרך הסוכן. אם המנהל מבקש — הסבר שזה צריך להיעשות מהמסך הייעודי.\n"
