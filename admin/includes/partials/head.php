...
<head>
    ...
    <link rel="stylesheet" href="<?php echo htmlspecialchars(rtrim(BASE_URL, '/') . '/admin/assets/css/admin.css', ENT_QUOTES, 'UTF-8'); ?>">
    <link rel="stylesheet" href="<?php echo htmlspecialchars(rtrim(BASE_URL, '/') . '/admin/assets/css/tazrim-dialog.css', ENT_QUOTES, 'UTF-8'); ?>">
    <script src="<?php echo htmlspecialchars(rtrim(BASE_URL, '/') . '/assets/js/tazrim_dialogs.js', ENT_QUOTES, 'UTF-8'); ?>"></script>
</head>
