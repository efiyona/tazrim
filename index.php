...
<body class="bg-gray">
    ...
    (function(){
      ...
      if(!dismissed){popup.hidden=false;popup.setAttribute('aria-hidden','false');}
      popup.querySelector('.payment-feature-announcement__close').addEventListener('click',dismiss);
